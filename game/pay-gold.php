        ...
        <div class="card" style="border: 0px;">
            <div class="list-group">
              <div class="col-md-12" style="padding: 0px;">
                <img src="../img/pay/gold.jpg" style="box-shadow: 0 0 15px rgba(0,0,0,0.3);border-radius: 5px; margin-left:50px;">  
              </div>
          </div>
      </div>
  </div>
          ...
          <div class="row">
            <div class="col-md-4">
                ...
                <form method="post" action="https://money.yandex.ru/quickpay/confirm.xml">
                    <button type="submit" onclick="payment()" style="color: transparent; background-color: transparent; border-color: transparent;" style="text-decoration: none; ">
                        ...
                        <input type="hidden" name="targets" value="Набор Gold">   
                        <input type="hidden" name="sum" value="99" data-type="number"> 
            ...
            <div class="col-md-4">
                <form method="post" action="../include/pay-qiwi.php"><?php $email = $_POST['email']; ?>
                        ...
                        <input type="hidden" id="qiwi_promo" name="price" value="99">  
    ...
    <div class="col-md-5 order-first">
        <div class="jumbotron" style="padding: 20px; margin-top: 1px;">
            <div class="row">
                ...
                <div class="col-md-5"><h3 align="right" style="font-weight: 600;">99 ₽</h3></div>
            </div>
            <hr>
...
<div class="container d-lg-none d-xl-none" style="margin-top: 25px;">
    <div class="card" style="border: 0px;">
        ...
        <img src="../img/pay/gold.jpg" style="box-shadow: 0 0 15px rgba(0,0,0,0.3);border-radius: 5px;width: 150px; margin-left:auto; margin-right: auto;">

        ...
        <div class="card" style="border: 0px;">
            <div class="list-group">
                <div class="col-md-12" style="padding: 0px;">
                  <?php
                  include_once "../include/payer.php"; 
                  ?>
              </div>
          </div>
      </div>
          ...
          <div class="row">
            <div class="col-md-4">
                ...
                <form method="post" action="https://money.yandex.ru/quickpay/confirm.xml">
                    <button type="submit" onclick="payment()" style="color: transparent; background-color: transparent; border-color: transparent;" style="text-decoration: none; ">
                        ...
                        <input type="hidden" name="targets" value="Лицензионный ключ <?php echo $game; ?>">   
            ...
            <div class="col-md-4">
                <form method="post" action="../include/pay-qiwi.php"><?php $email = $_POST['email']; ?>
                        ...
                        <input type="hidden" id="qiwi_promo" name="price" value="<?php echo $price; ?>">  
    ...
    <div class="col-md-5 order-first">
        <div class="jumbotron" style="padding: 20px; margin-top: 1px;">
            <div class="row">
                ...
                <div class="col-md-5"><h3 align="right" style="font-weight: 600;"><?php echo "$price"; ?> ₽</h3></div>
            </div>
            <hr>
...
<div class="container d-lg-none d-xl-none" style="margin-top: 25px;">
    <div class="card" style="border: 0px;">
      ...
      <?php
      include_once "../include/payer-mini.php"; 
      ?>

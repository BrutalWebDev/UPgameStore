    ...
    <div class="container">
       <div class="row"> 
        <div class="col-md-9" style="">
            <div class="jumbotron">
                <h3 style="font-weight: 600;">Как активировать?</h3><hr>
                <p style="font-size: 26px;"><i class="fas fa-angle-right"></i> Выбрать игру</p>
                <p style="font-size: 26px;"><i class="fas fa-angle-right"></i> Оплатить заказ</p>
                <p style="font-size: 26px;"><i class="fas fa-angle-right"></i> Забрать персональный промо-код на вашей почте</p>
            </div>
        </div>
